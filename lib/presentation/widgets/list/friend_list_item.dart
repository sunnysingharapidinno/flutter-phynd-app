            ...
            Row(
              ...
              children: [
                (widget.isGame ?? false)
                    ...
                    : ImageThumbnail(
                        imageUrl: isProfileImageValid
                            ? widget.profileImage!
                            : AppImages.profileAvatarRed,
                        height: 80,
                        width: 80,
                        fit:
                            isProfileImageValid ? BoxFit.cover : BoxFit.contain,
                        borderRadius: 200,
                        isNetwork: isProfileImageValid,
            ...
            if (widget.isRequest)
              SizeTransition(
                ...
                child: FadeTransition(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsets.only(top: SizeUtils.pxToDp(context, 20)),
